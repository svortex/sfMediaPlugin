 ...
 */
class sfMediaImageForm extends BasesfMediaImageForm
{
  /**
   * @see sfMediaFileForm
   */
  ...
  public function save($con = null)
    {
      ...
      try{
        ...
        $image->setSmall($this->resizeFile(50,$file,$filename,$extension));
        $image->setMedium($this->resizeFile(80,$file,$filename,$extension));
        $image->setLarge($this->resizeFile(150,$file,$filename,$extension));
